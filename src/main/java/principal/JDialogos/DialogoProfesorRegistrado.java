...
/**
 * DialogoProfesorRegistrado es una ventana de dialogo que un dialogo de que se a podido registrar al profesor correctamente tras realizar el registro en Register.
 * @author Zenon Perez
 */
public class DialogoProfesorRegistrado extends javax.swing.JDialog {

    /**
     * Aqui es donde se crea el nuevo form de DialogoProfesorRegistrado.
     ...
     */
    public DialogoProfesorRegistrado(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lbl_Mensaje.setText("El profesor se ha registrado correctamente");
