...
/**
 * DialogoErrorRangoNumerosValoracion es una ventana de dialogo que nos muestra un mensaje de error el cual indica que en una valoracion solo podemos poner numeros del 0 al 10.
 * @author Zenon Perez
 */
public class DialogoErrorRangoNumerosValoracion extends javax.swing.JDialog {

    /**
     * Aqui es donde se crea el nuevo form de DialogoErrorRangoNumerosValoracion
     * @param parent nos muestra que esta ventana sale de un JDialog que en este caso sale de una de las ventanas de dar valoracion.
     * @param modal nos dice si la ventana es modal o no, en este caso es modal.
     */
    public DialogoErrorRangoNumerosValoracion(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lbl_Mensaje.setText("Solo puedes poner un numero de 0 al 10");
