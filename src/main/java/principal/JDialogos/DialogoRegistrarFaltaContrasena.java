...
/**
 *  DialogoRegistradoFaltaContrasena es una ventana de dialogo que muestra un error y aparece cuando se inetenta registrar a un usuario y la contasenya esta vacia.
 * @author Zenon Perez
 */
public class DialogoRegistrarFaltaContrasena extends javax.swing.JDialog {

    /**
     * Aqui es donde se crea el nuevo form de DialogoRegistrarFaltaContrasena.
     ...
     */
    public DialogoRegistrarFaltaContrasena(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lbl_Mensaje.setText("La contraseña no puede estar vacia");
