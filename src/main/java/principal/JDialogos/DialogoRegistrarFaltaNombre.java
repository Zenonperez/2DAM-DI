...
/**
 * DialogoRegistrarFaltaNombre es una ventan de dialogo la cual muestra un error que ocurre al dejar vacio el campo de nombre.
 * @author Zenon Perez
 */
public class DialogoRegistrarFaltaNombre extends javax.swing.JDialog {

     /**
     * Aqui es donde se crea el nuevo form de DialogoRegistrarFaltaNombre.
     ...
     */
    public DialogoRegistrarFaltaNombre(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lbl_Mensaje.setText("El nombre no puede estar vacio");
