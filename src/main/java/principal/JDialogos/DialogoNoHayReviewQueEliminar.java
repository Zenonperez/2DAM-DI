...
/**
 * DialogoNoHayReviewQueEliminar es una ventana de dialogo que muestra un error que saltara al intentar eliminar la review de un intento que no tiene review
 * @author Zenon Perez
 */
public class DialogoNoHayReviewQueEliminar extends javax.swing.JDialog {

    /**
     * Aqui es donde se crea el nuevo form de DialogoNoHayReviewQueEliminar.
     ...
     */
    public DialogoNoHayReviewQueEliminar(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lbl_Mensaje.setText("Este intento no tiene una review para eliminar");
