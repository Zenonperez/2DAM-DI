...
/**
 *  DialogoBienvenida es una ventana dialogo que da un mensaje de bienvenido al conectarse a la aplicacion 
 * @author Zenon Perez
 */
public class DialogoBienvenida extends javax.swing.JDialog {

    /**
     * Aqui se crea el form de DialogoBienvenida
     ...
     * @param user es el usuario el cual se ha conectado a la aplicacion
     */
    public DialogoBienvenida(javax.swing.JDialog parent, boolean modal, Usuari user) {
        super(parent, modal);
        initComponents();
        //Ponemos el borde blanco para resaltar la ventana.
        getRootPane().setBorder(BorderFactory.createLineBorder(Color.WHITE, 1));
        lbl_Mensaje.setText("Sesion iniciada. Bienvenido " + user.getNombre());
    }
    ...
    private void initComponents() {
        ...
        lbl_Mensaje.setText("Sesion iniciada. Bienvenido");
