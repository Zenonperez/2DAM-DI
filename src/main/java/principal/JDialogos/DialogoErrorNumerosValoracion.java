...
/**
 * DialogoErrorNumerosValoracion es una ventana de dialogo que nos muestra un mensaje de error el cual nos indica que hay que poner solo numeros en la valoracion.
 * @author Zenon Perez
 */
public class DialogoErrorNumerosValoracion extends javax.swing.JDialog {

    /**
     * Aqui es donde se crea el nuevo form de DialogoErrorNumerosValoracion
     ...
     */
    public DialogoErrorNumerosValoracion(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lbl_Mensaje.setText("Solo puedes poner numeros en la valoracion");
