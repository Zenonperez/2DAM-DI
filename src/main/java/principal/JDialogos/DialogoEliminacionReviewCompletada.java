...
/**
 * DialogoEliminacionReviewCompletada es una ventana de dialogo que nos muestra un mensaje de que la review a sido correctamente eliminada al eliminar una review
 * @author Zenon Perez
 */
public class DialogoEliminacionReviewCompletada extends javax.swing.JDialog {

    /**
     * Aqui es donde se crea el nuevo form de DialogoEliminacionReviewCompletada
     ...
     */
    public DialogoEliminacionReviewCompletada(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lbl_Mensaje.setText("Se ha eliminado la review correctamente");
